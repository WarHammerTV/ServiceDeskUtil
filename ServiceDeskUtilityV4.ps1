...
$MainForm.Icon                       = [System.Drawing.Icon]::ExtractAssociatedIcon('C:\servicedeskutility\Assets\icon.ico')
$MAinform.StartPosition              = "CenterScreen"
$MainForm.BackColor                 = "#161716
"
...
$btnExcelResolve.ForeColor                   = "#bfbebb"
$btnExcelResolve.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$btnDatasetFunction.ForeColor                   = "#bfbebb"
$btnDatasetFunction.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$btnCitrix.ForeColor                   = "#bfbebb"
$btnCitrix.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$btnD365Gen.ForeColor                   = "#bfbebb"
$btnD365Gen.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$btnHello.ForeColor                   = "#bfbebb"
$btnHello.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$BtnIncomingCall.ForeColor                   = "#bfbebb"
$BtnIncomingCall.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$UsernameInput.ForeColor                   = "#bfbebb"
...
$UsernameLabel.ForeColor                   = "#bfbebb"
...
$TicketTitleLabel.ForeColor                   = "#bfbebb"
...
$issuebodylabel.ForeColor                   = "#bfbebb"
...
$stepstakenlabel.ForeColor                   = "#bfbebb"
...
$locationlabel.ForeColor                   = "#bfbebb"
...
$btnWriteTicket.ForeColor                   = "#bfbebb"
$btnWriteTicket.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$BtnGenpass.ForeColor                   = "#bfbebb"
$BtnGenpass.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$BtnSmplGenpass.ForeColor                   = "#bfbebb"
$BtnSmplGenpass.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
#Button to Open tickets folder
$btnTicketOpen = New-Object system.Windows.Forms.Button
$btnTicketOpen.text = "Tickets"
$btnTicketOpen.width = 60
$btnTicketOpen.height = 35
$btnTicketOpen.location = New-Object System.Drawing.Point(850,560)
$btnTicketOpen.Font = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
$btnTicketOpen.ForeColor                   = "#bfbebb"
$btnTicketOpen.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat

############################### Control form ###################################################
$MainForm.controls.AddRange(@($SDTitle,$Clientspeclabel,$genericLabel,$btnExcelResolve,$btnDatasetFunction,$btnCitrix,$UsernameInput,$UsernameLabel,$btnHello,$btnLiveChat,$btnStdResolve,$Title,$TicketTitle,$TicketTitleLabel,$issuebody,$issuebodylabel,$stepstakenbody,$stepstakenlabel,$vwmbody,$vwmlabel,$contactbody,$contactlabel,$locationbody,$locationlabel,$btnWriteTicket,$btnD365Gen,$BtnGenpass,$PassgenLabel,$PassGenOutput,$BtnSmplGenpass,$PassSmplGenOutput,$BtnIncomingCall,$btnTicketOpen))
...
$btnTicketOpen.Add_Click({Start-TicketOpen})
...
Function Start-TicketOpen{
    Invoke-Item -Path C:\ServiceDeskUtility\Tickets
...
"
    ...
    new-item -path C:\ServiceDeskUtility\tickets\ -name "$ticket.txt" -ItemType "File" -Value "$finalticket"
...
"
    ...
    Function write-extra {
        ...
        $ExtraForm.BackColor                  = "#161716"
        $ExtraForm.Icon                       = [System.Drawing.Icon]::ExtractAssociatedIcon('C:\servicedeskutility\Assets\icon.ico')
        ...
        $extrabodylabel.ForeColor                   = "#bfbebb"
        ...
        $btnRunFunction.ForeColor                   = "#bfbebb"
        $btnRunFunction.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
...
$outputLabeler.ForeColor                   = "#bfbebb"
...
#Opening new window with incoming call ticket input form
    ...
    $IncomingCall.BackColor                  = "#161716"
    $IncomingCall.Icon                       = [System.Drawing.Icon]::ExtractAssociatedIcon('C:\servicedeskutility\Assets\icon.ico')
    $IncomingCall.StartPosition              = "CenterScreen"
    ...
    $ICTicketTitleLabel.ForeColor                   = "#bfbebb"
    ...
    $ICissuebodylabel.ForeColor                   = "#bfbebb"
    ...
    $ICstepstakenlabel.ForeColor                   = "#bfbebb"
    ...
    $ICcontactlabel.ForeColor                   = "#bfbebb"
    ...
    $IClocationlabel.ForeColor                   = "#bfbebb"
    ...
    $ICbtnWriteTicket.ForeColor                   = "#bfbebb"
    $ICbtnWriteTicket.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat
    ...
    $Usersname = $ICUserVar.Text
    
    $finalICticket = "$Usersname
$ICBodyInfo
$ICExtras
...
"
    ...
    $masterpath = "C:\servicedeskutility\tickets\MasterRecord.txt"
